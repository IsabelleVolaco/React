...
import { Image, StyleSheet, Platform, View } from 'react-native'; // Adicionei 'View' na importação
import { HelloWave } from '@/components/HelloWave';
import ParallaxScrollView from '@/components/ParallaxScrollView';
import { ThemedText } from '@/components/ThemedText';
import { ThemedView } from '@/components/ThemedView';
import Calculator from './calculadora'; // Verifique se o caminho está correto
  ...
  return (
    ...
    >
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">AAAAAAAKIODIO</ThemedText>
        <HelloWave />
      </ThemedView>
      ...
      {/* Renderiza a calculadora no final da página inicial - chama de "calculadora.tsx" */}
